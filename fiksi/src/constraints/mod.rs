...
impl LineLineParallelism {
    /// Construct a constraint between two lines to describe a given angle.
    pub fn new(line1: ElementHandle<elements::Line>, line2: ElementHandle<elements::Line>) -> Self {
        Self { line1, line2 }
    }
}
...
impl sealed::ConstraintInner for LineLineParallelism {
    fn as_edge(&self, vertices: &[Vertex]) -> Edge {
        ...
        Edge::LineLineParallelism(LineLineParallelism_ {
            line1_point1_idx,
            line1_point2_idx,
            line2_point1_idx,
            line2_point2_idx,
...
/// A representation of a [`LineLineParallelism`] constraint within a [`crate::System`], allowing
/// evaluation.
///
/// TODO: can this be merged with [`LineLineParallelism`]?
pub(crate) struct LineLineParallelism_ {
    pub line1_point1_idx: u32,
    pub line1_point2_idx: u32,
    pub line2_point1_idx: u32,
    pub line2_point2_idx: u32,
